...
| Herdr protocol 21 compatibility | `herdr-protocol-21` in `herdr-protocol-21` worktree | adapter protocol gate, protocol docs, QML incompatibility fixture | Installed from `750640e`; full gate and independent closure review pass, live protocol-21 adapter reports 20 agents and priority ordering after the 49-pane Herdr handoff |
