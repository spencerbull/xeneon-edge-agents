...
| Herdr v0.9 protocol 22 | `herdr-v0.9-protocol-22` in `herdr-v0.9-protocol-22` worktree | Herdr protocol gate, adapter fixtures, protocol docs | Installed and live-verified: protocol 22 connected, 29 agents on the physical EDGE; stock 0.9.0 has no agent-order or perform-action methods |
